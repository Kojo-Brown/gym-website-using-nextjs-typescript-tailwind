...
const Footer = () => {
  return (
    <footer className="text-center lg:text-left bg-gray-100 text-gray-600 mb-10">
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Our Programme</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Our Plan</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Become a member</a>
        </p>
        <p>
          <a href="#!" className="text-gray-600">Ice-cream</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
