    ...
    <section className="sm:flex flex-col gap-20 lg:flex-row w-full items-center">
      <div className="sm:right flex flex-col gap-8 lg:w-1/2">
        ...
        <span>
          ...
          autem nemo? Dolorum temporibus minima assumenda omnis totam tempora et
          aspernatur labore quibusdam rem, quod suscipit repudiandae eaque
          dolore commodi recusandae!
        </span>
