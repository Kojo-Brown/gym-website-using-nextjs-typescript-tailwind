    ...
    <nav className="xl:flex justify-between items-center py-4 px-4 sm:flex">
      ...
      <div className="flex gap-20">
        <ul className="relative xl:flex items-center gap-10 sm:hidden">
          <li>Home</li>
          <li>About</li>
          <li onClick={() => setServicesDropdown(!servicesDropdown)} className="relative flex items-center">
            Services <BiChevronDown color="orange" />
            {servicesDropdown && <ul className="absolute top-8 bg-orange-500 px-3 py-1 rounded-md">
                    <li>Item 1</li>
                    <li>Item 2</li>
                    <li>Item 3</li>
                </ul>}
          </li>
          <li onClick={() => setPricingDropdown(!pricingDropdown)} className="flex items-center z-999">
            Pricing <BiChevronDown color="orange" />
            {pricingDropdown && <ul className="absolute top-10 bg-orange-500 px-3 py-1 rounded-md">
                    <li>Item 1</li>
                    <li>Item 2</li>
                    <li>Item 3</li>
                </ul>}
        ...
        <div className="relative flex items-center gap-16">
          ...
          <button onClick={() => setMenuDropdown(!menuDropdown)} className="bg-slate-900 rounded-md p-2 xl:hidden lg:block">
            <FiMenu color="white" size='1rem' />
            {menuDropdown && <ul className="absolute top-10 right-0 w-32 mt-2 bg-orange-200 px-3 py-1 rounded-md">
                    <li>Home</li>
                    <li>About</li>
                    <li>Services</li>
                    <li>Pricing</li>
